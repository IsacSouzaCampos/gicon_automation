...
IR_KEYWORDS = [' ir ', 'ir:', 'ir1,50%', 'irrf1,50%', 'ir1,5%', 'irrf1,5%', 'ir1.50%',
...
PIS_KEYWORDS = ['pis', 'pis:', 'pis0,65%', 'pis0.65%', 'pis,65%', 'pis.65%', 'pisr$',
                'pis(', 'pis/pasep',
                'retencaopis', 'retencaodepis', 'retencoespis', 'recolherpis']

COFINS_KEYWORDS = ['cofins', 'cofns', 'cofins3%', 'cofins3.0%', 'cofins3.00%',
                   'cofins3,0%', 'cofins3,00%', 'cofinsr$',
                   'cofins(', 'cofins:',
                   'retencaocofins', 'retencaodecofins', 'retencoescofins', 'recolhercofins']

CSLL_KEYWORDS = ['csll', 'csll1%', 'csll1.0%', 'csll1.00%',
...
CSRF_KEYWORDS = ['csrf', 'csrf4,65%', 'csrf4.65%', 'csrfr$',
